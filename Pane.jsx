    ...
    return (
        ...
        <div className="w-[400px] bg-white p-4 shadow-lg rounded-lg">
            ...
            <div className='p-[20px] items-center'>
              ...
              {!accessToken ? (
                  <button className='px-[10px] py-[20px] size-[16px] cursor-pointer bg-[#4285F4] text-white rounded-[5px]' onClick={handleConnect}>
                  Kết nối Google
                  </button>
              ) : (
                  <button className='px-[10px] py-[20px] size-[16px] cursor-pointer bg-[#28a745] text-white rounded-[5px]' onClick={createNewCalendarAndEvent}>
